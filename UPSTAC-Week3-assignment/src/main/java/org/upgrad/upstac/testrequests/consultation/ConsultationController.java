...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // object of User class gets and store the current logged in user first
        // returns the list of test requests assigned to current doctor(make use of the above created User object)
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        // object of User class gets the current logged in user
    ...
    public TestRequest updateConsultation(@PathVariable Long id, @RequestBody CreateConsultationRequest testResult) {
        ...
        // object of the User class gets the logged in user
